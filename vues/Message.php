    ...
    <div class="chat&patient">
        <div class="chats">
            <div>
                <div id="pict1"></div>
                <p class="a1">Nikita</p>
                <p class="b1">9.05 Aujourd'hui</p>
                <div class="backmes1">
                    <p class="c1">Bonjour Romain, je pense que vu l'avancée de l'infection il faut extraire l'inplant ...</p>
                </div>
            </div>
            <div>
                <p class="b2">9.08 Aujourd'hui</p>
                <div class="backmes2">
                    <p class="c2">Bonjour Nikita, je m'en doutais mais je voulais confirmation. Merci</p>
                </div>
            </div>
            <div>
                <div id="pict2"></div>
                <p class="a2">Nikita</p>
                <p class="b3">9.10 Aujourd'hui</p>
                <div class="backmes3">
                    <p class="c3">De rien.</p>
                </div>
            </div>
            <div>
                <div id="pict3"></div>
            ...
            <div>
                <div id="pict4"></div>
                <p class="a4">Mounia</p>
                <p class="b5">9.34 Aujourd'hui</p>
                <div class="backmes5">
                    <p class="c5">Il y a t'il mobilitée ?</p>
                </div>
            </div>
            <div>
                <p class="b6">9.42 Aujourd'hui</p>
                <div class="backmes6">
                    <p class="c6">Non, aucune. Y a t'il besoin de mettre le patient sous antibiotique ?</p>
                </div>
            </div>
            <div>
                <div id="pict5"></div>
